...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of MKWalkthrough.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/minamakary25/MKWalkthrough'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'minamakary25' => 'minamakary25@gmail.com' }
  s.source           = { :git => 'https://github.com/minamakary25/MKWalkthrough.git', :tag => s.version.to_s }
